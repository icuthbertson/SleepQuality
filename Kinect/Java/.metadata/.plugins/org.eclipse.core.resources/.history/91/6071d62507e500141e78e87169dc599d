...
public class ServerComms {
	...
	private static void sendData() throws IOException {
		...
		BufferedReader r = new BufferedReader(new FileReader("move" + date + ".txt"));
		...
		r = new BufferedReader(new FileReader("REM" + date + ".txt"));
		...
		r = new BufferedReader(new FileReader("Dist" + date + ".txt"));
